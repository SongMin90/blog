...
public class SiteServiceImpl implements ISiteService {
    ...
    public StatisticsBo getStatistics() {
        ...
        Long visitors = visitorDao.selectAllCount();

        Long logs = logDao.countByExample(null);

        Long chats = chatDao.findAllCount();
        ...
        statistics.setLogs(logs);
        statistics.setChats(chats);
